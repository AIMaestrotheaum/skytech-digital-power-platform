...
export default function Login() {
  ...
  const handleLogin = async (event) => {
    ...
    try {
      ...
      if (rememberMe) {
        localStorage.setItem("skytech_token", data.access_token);
        localStorage.setItem("skytech_role", data.role);
        localStorage.setItem("skytech_user", data.name);
      } else {
        sessionStorage.setItem("skytech_token", data.access_token);
        sessionStorage.setItem("skytech_role", data.role);
        sessionStorage.setItem("skytech_user", data.name);
      }
        ...
        <div className="relative z-10 flex flex-col h-full justify-between p-16 text-white">
          ...
          <div className="max-w-md">
            ...
            <p className="text-lg leading-relaxed text-gray-300">
              Secure access to real-time analytics, predictive maintenance
              alerts, and comprehensive asset health tracking across your
            ...
            <div className="mt-10 pt-4 border-t border-gray-200 text-center">
              ...
              <p className="text-xs font-mono text-[#44474d]">
                ...
                <button
                  type="button"
                  onClick={() =>
                    setError("Contact Support will be connected next.")
                  }
